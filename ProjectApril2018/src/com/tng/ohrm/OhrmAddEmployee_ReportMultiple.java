...
public class OhrmAddEmployee_ReportMultiple  {
   WebDriver driver;
	...
	public void openApplication(){
	     ...
	     test = report.startTest("OpenApplication");
		  System.setProperty("webdriver.chrome.driver","D:/Selenium2018downloads/Browserdrivers/chromedriver_win32/chromedriver.exe");
			...
			try{
			assertTrue(driver.getTitle().equalsIgnoreCase("orangehrm123"),"TitleVerification");
			test.log(LogStatus.PASS, "OpenApplication", "Application opened successfully");
			}
			catch(AssertionError ae){
				String errfolderpath = "D:\\ProjectApril2018\\Results\\ErrorImages";
				String imagepthreturned = CommonMethods.getScreenShot(driver, errfolderpath);
				test.log(LogStatus.FAIL, "OpenApplication", "correct page is notopened successfully"+test.addScreenCapture(imagepthreturned));
	  ...
	  @Test
	  public void Login(){
		  test = report.startTest("Login Ohrm");
